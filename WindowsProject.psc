...
Funcion windowCharChained = GraphMainWindowToChain()
	...
	Dimension vr[10]
	vr[0]="OPCION 1¥Una breve descripción reve descripción y 12 tiros den y 12 n y 12 tiros de un pajaro loco mas sin siquie  mas tiros de un pajaro loco mas sin siquie  mas  un pajaro loco mas sin siquie  mas sin siquie cayeron por demas sin siquiera pensarlo y ni ha bde las y que  mas quisiera yo si no se si cantar cosas de la vida y otras yerbas"
	vr[1]="OPCION 2¥Una breve descripción de las cosas de la vida y otras yerbas"
	vr[2]="OPCION 3¥Una breve descripción y 12 tiros de un pajaro loco cayeron por demas sin siquiera pensarlo y ni hablar por ahi de otras cosas del querer"
	vr[3]="OPCION 4¥Una breve descripción de las cosas de la vida y otras yerba"
	vr[4]="OPCION 5¥Una breve descripción de las cosas de la vida y otras yerba"
	vr[5]="OPCION 6¥Una breve descripción de las cosas de la vida y otras yerba"
	vr[6]="OPCION 7¥Una breve descripción de las cosas de la vida y otras yerba"
	vr[7]="OPCION 8¥Una breve descripción de las cosas de la vida y otras yerba"
	vr[8]="INFO¥Informacion general de esta aplicacion y de sus utilidades a traves del tiempo"
	vr[9]="SALIR¥Tomarse el reverendo palo"
...
Funcion windowCharChained = GraphSecondWindowToChain()
	...
	vr[1]="SALIR¥Tomarse el reverendo palo"
	Para cada item de vr
		windowCharChained=windowCharChained+item+"¶"
	FinPara
